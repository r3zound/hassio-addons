...
⚠️ 本项目正在积极开发中。可能会有错误和变化。请勿将其作为存储照片和视频的唯一方式！（来自开发者）
...
_感谢所有给我的仓库点星的人！要点星，请点击下方的图片，然后它会在右上方。谢谢！_

[![星标者的代码库 @alexbelgium/hassio-addons](https://raw.githubusercontent.com/alexbelgium/hassio-addons/master/.github/stars2.svg)](https://github.com/alexbelgium/hassio-addons/stargazers)
...
请注意，您需要安装一个单独的 PostgreSQL 插件以能够连接数据库。您可以在我的仓库中安装 PostgreSQL 插件。
请确保在启动之前更改密码；之后将无法更改。

## 支持

在 GitHub 上创建问题，或在 [家庭助手讨论区](https://community.home-assistant.io/t/home-assistant-addon-immich/282108/3) 中询问。
