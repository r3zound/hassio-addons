...
⚠️ 该项目正在积极开发中。可能会出现错误和变更。请不要将其作为存储照片和视频的唯一方式！（来自开发者）
...
该插件的安装相当简单，并与安装任何其他Hass.io插件没有区别。
...
在GitHub上创建一个问题，或者在[家居助手讨论区](https://community.home-assistant.io/t/home-assistant-addon-immich/282108/3)中询问。
