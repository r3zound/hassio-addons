...
此附加组件允许您编写配置，并通过 Home Assistant 将微控制器
直接转变为智能家居设备 **无需编程经验**。
您所需要做的仅是编写 YAML 配置文件；其余（无线更新、编译）均由 ESPHome
处理。

<p align="center">
<img title="ESPHome 设备构建器屏幕截图" src="https://github.com/esphome/home-assistant-addon/raw/main/esphome/images/screenshot.png" width="700px"></img>
</p>
...
使用 ESPHome，您可以从几行 YAML 直接生成自定义固件。例如，要包括一个 [DHT22][dht22]
