## &#9888; 开放请求 : [✨ [请求] Immich 框架 (打开于 2025-02-13)](https://github.com/alexbelgium/hassio-addons/issues/1764) 由 [@NickBootOne](https://github.com/NickBootOne)
## &#9888; 开放请求 : [✨ [请求] immich 和 Nextcloud Ingress 支持 (打开于 2025-03-15)](https://github.com/alexbelgium/hassio-addons/issues/1812) 由 [@bessertristan09](https://github.com/bessertristan09)
# Home Assistant 附加组件：immich

⚠️ 此项目正在积极开发中。请预期有错误和更改。不要仅将其作为存储您照片和视频的唯一方法！ （开发者声明）
...
[donation-badge]: https://img.shields.io/badge/请给我买杯咖啡（无PayPal）-%23d32f2f?logo=buy-me-a-coffee&style=flat&logoColor=white
[paypal-badge]: https://img.shields.io/badge/用PayPal给我买杯咖啡-0070BA?logo=paypal&style=flat&logoColor=white

_感谢所有给我的库加星的朋友们！要给它加星，请点击下面的图像，然后在右上角。谢谢！_
...
1. 仔细根据您的偏好配置附加组件，具体请参见官方文档。

请注意，您需要安装一个单独的 postgres 附加组件才能连接数据库。您可以在我的库中已经安装 postgres 附加组件。
请注意在启动之前更改密码；之后它不会再更改。

## 支持

在 GitHub 上创建一个问题，或在 [Home Assistant 讨论区](https://community.home-assistant.io/t/home-assistant-addon-immich/282108/3) 询问。
