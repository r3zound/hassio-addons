...
此模板提供了一个最小化配置，以使 React 在 Vite 中运行，并支持热模块替换（HMR）以及一些 ESLint 规则。
...
由于对开发和构建性能的影响，此模板默认未启用 React 编译器。要添加它，请参阅[此文档](https://react.dev/learn/react-compiler/installation)。
