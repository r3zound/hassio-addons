...
⚠️ 该项目正在非常活跃地开发中。请预计会有错误和更改。不要将其作为存储照片和视频的唯一方式！（来自开发者）
...
_感谢所有给我的仓库加星的人！要加星请点击下方的图片，然后它会在右上角。谢谢！_

[![星标为 @alexbelgium/hassio-addons 的星标者](https://raw.githubusercontent.com/alexbelgium/hassio-addons/master/.github/stars2.svg)](https://github.com/alexbelgium/hassio-addons/stargazers)
...
1. 启动插件。
1. 检查插件的日志以查看是否一切顺利。
1.仔细按照您的偏好配置插件，具体请参见官方文档。

请注意，您需要安装一个单独的 postgres 插件才能连接数据库。您可以在我的库中已经安装 postgres 插件。
请注意在启动之前更改密码； 否则之后将无法更改。

## 支持

在 GitHub 上创建一个问题，或在 [home assistant 线程](https://community.home-assistant.io/t/home-assistant-addon-immich/282108/3) 中询问。
