...
_感谢所有给我的仓库加星的人！要加星，请点击下面的图片，然后会出现在右上角。谢谢！_
...
管理 Docker 从未如此简单。Portainer 提供详细的 Docker 概述，并允许您管理容器、镜像、网络和卷。

## 还原备份

打开插件选项并将密码设置为“空”。重新启动插件，这将允许从备份中还原 Portainer。您需要将备份放在可访问的文件夹中，例如 /share，以便在插件中挂载。

## 警告

Portainer 插件非常强大，几乎可以让您访问整个系统。尽管这个插件是在安全的考虑下创建和维护的，但如果落入错误或没有经验的手中，可能会对您的系统造成损害。
...
1. 将我的插件库添加到您的 Home Assistant 实例中（在超级用户插件商店右上角，或者如果您已配置我的 HA，请单击下面的按钮）
