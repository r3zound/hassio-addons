...
/k2fsa/venv/bin/python /k2fsa/python-api-examples/streaming_server.py --port 6005 --tokens /config/addons_config/k2fsa/tokens.txt --encoder /config/addons_config/k2fsa/encoder-epoch-12-avg-4.onnx --decoder /config/addons_config/k2fsa/decoder-epoch-12-avg-4.onnx --joiner /config/addons_config/k2fsa/joiner-epoch-12-avg-4.onnx --max-batch-size 5
