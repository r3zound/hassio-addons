# Home Assistant 插件：Binance 交易机器人（请勿使用真实货币！）
...
_感谢所有关注我的仓库的人！要关注，请点击下面的图像，然后它将位于右上角。谢谢！_

[![关注者人数](https://raw.githubusercontent.com/alexbelgium/hassio-addons/master/.github/stars2.svg)](https://github.com/alexbelgium/hassio-addons/stargazers)

![下载演变](https://raw.githubusercontent.com/alexbelgium/hassio-addons/master/binance-trading-bot/stats.png)

## 关于

自动化的 Binance 交易机器人 - 交易多种加密货币。使用网格交易来低买高卖。与 TradingView 技术分析集成。
此插件基于 https://github.com/chrisleekr/binance-trading-bot。

这是一个测试应用；如有任何问题，请联系以上链接。

## 配置

Webui 可在 <http://homeassistant:80> 找到。
请参见 https://github.com/chrisleekr/binance-trading-bot 进行配置。
