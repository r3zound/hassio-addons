...
![Version](https://img.shields.io/badge/dynamic/yaml?label=版本&query=%24.version&url=https%3A%2F%2Fraw.githubusercontent.com%2Falexbelgium%2Fhassio-addons%2Fmaster%2Fbooksonic_air%2Fconfig.yaml)
...
[Booksonic-air](http://booksonic.org/) 是一个平台，用于在任何地方访问您拥有的有声读物。目前，该平台包括 Booksonic Air - 一个用于流式传输您有声读物的服务器，是原始 Booksonic 服务器的继任者，基于 Airsonic。Booksonic App - 一个基于 DSub 的 Android 应用程序，用于连接到 Booksonic-Air 服务器。
此插件基于 Docker 镜像 https://github.com/linuxserver/docker-booksonic-air
...
Webui 可以在 <http://homeassistant:4040> 找到。
默认凭证显示在启动日志中。
