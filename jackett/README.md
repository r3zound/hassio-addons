...
_感谢所有给我的仓库加星的人！要加星，请点击下面的图像，然后它将显示在右上角。谢谢！_
...
[jackett](https://github.com/jackett/jackett) - 一个 jackett 的分支，用于处理像 Couchpotato 这样的电影。
...
GPID: 用户
TZ: 时区
localdisks: sda1 # 输入你的驱动器挂载的硬件名称，用逗号分隔，或者它的标签。比如 sda1, sdb1, MYNAS...
...
安装这个插件非常简单，与安装任何其他 Hass.io 插件没有什么区别。
