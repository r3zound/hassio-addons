...
_感谢所有给我的仓库加星的人！要加星请点击下面的图片，然后它将出现在右上角。感谢！_

[![@alexbelgium/hassio-addons 的 Stargazers 报名名单](https://raw.githubusercontent.com/alexbelgium/hassio-addons/master/.github/stars2.svg)](https://github.com/alexbelgium/hassio-addons/stargazers)
...
[Autobrr](https://autobrr.com/) Autobrr 是现代的种子下载自动化工具。它的灵感和创意来源于 trackarr、autodl-irssi 和 flexget，我们构建了一个可以做所有这些的工具，还有更多功能。
...
1. 将我的插件仓库添加到您的 Home Assistant 实例中（在监督员插件商店右上角，或如果您已配置我的 HA，请单击下面的按钮）
...
GPID: 用户
TZ: 时区
localdisks: sda1 # 将您的驱动器硬件名称以逗号分隔放入，或其标签。例如：sda1, sdb1, MYNAS...
